			...
			config = function()
				...
				null_ls.setup({
					sources = {
						...
						null_ls.builtins.formatting.prettier, -- JS, TS, Vue, Css, HTML, JSON, MD, Astro
						null_ls.builtins.formatting.phpcsfixer, -- PHP
						null_ls.builtins.formatting.duster, -- Laravel
						null_ls.builtins.formatting.stylua, -- Lua
						null_ls.builtins.formatting.cljfmt, -- Clojure
